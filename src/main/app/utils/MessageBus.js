...
export const getMessageBus = function () {
  ...
  var processMessages = function (messages) {
    ...
    $.each(messages, function (_, message) {
      ...
      $.each(callbacks, function (_, callback) {
        if (callback.channel === message.channel || Object.keys(message.data).indexOf(callback.channel) != -1) {
  ...
  longPoller = function (poll, data) {
    ...
    return me.ajax({
      url: me.baseUrl + 'message-bus/' + me.clientId + '/poll?' +
           (!shouldLongPoll() || !me.enableLongPolling ? 'dlp=t' : ''),
      data: data,
      cache: false,
      ...
      headers: {
        ...
        'Authorization': 'Token ' + me.authToken
      },
  ...
  me = {
    ...
    diagnostics: function () {
      ...
      console.log('Total ajax calls: ' + totalAjaxCalls + ' Recent failure count: ' + failCount + ' Total failures: ' +
                  totalAjaxFailures);
...
// WEBPACK FOOTER //
// ./src/main/app/utils/MessageBus.js