...
import {PayoutForm} from '../../components/_payout-form/PayoutForm';
...
export const PayoutPage = connectToStores(class extends React.Component {
  static displayName = 'PayoutPage';
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    trackPageView(this.context, {path: `/settings/payout`});
  }
  ...
  render() {
    return <Page>
      <Head>
        <title>
          {this.context.intl.formatMessage({id: 'pages.payout.document_title'})}
        </title>
      </Head>
      <Body>
      <div className="min-h-100 flex-col">
        ...
        <div className="container-fluid w-100 m-md-b-3 m-t-2">
          <h1 className="text-center font-size-xl m-b-2">
            <FormattedMessage id="pages.payout.page_header"/>
          </h1>
          <div className="row">
...
// WEBPACK FOOTER //
// ./src/main/app/pages/_payout/PayoutPage.js