...
import {Verification} from '../../components/_verification/Verification';
...
export class IdentificationPage extends React.Component {
  static displayName = 'IdentificationPage';
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    trackPageView(this.context, {path: `/settings/identification`});
  }
  ...
  render() {
    return (
      <Page>
        <Head>
          <title>
            {this.context.intl.formatMessage({id: 'pages.identification.document_title'})}
          </title>
        </Head>
        <Body>
        <div className="min-h-100 flex-col">
          ...
          <div className="container-fluid w-100 m-md-b-3 m-t-2">
            <h1 className="text-center font-size-xl m-b-2">
              <FormattedMessage id="pages.identification.page_header"/>
            </h1>
            <div className="row">
...
// WEBPACK FOOTER //
// ./src/main/app/pages/_identification/IdentificationPage.js